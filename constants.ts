...
export const STYLES: StyleOption[] = [
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：柔和彩绘质感、细腻线条勾勒、复古色调（暖黄/棕褐）、光洁皮肤质感、怀旧滤镜、装饰边框元素、月份牌风格',
  },
  {
    id: 'ukiyo_e',
    name: '浮世绘风',
    ...
    promptModifier: '核心视觉特征：平面化色彩、强烈黑色轮廓线、木版画纹理、色彩平涂、线条韵律感、戏剧性构图、装饰性背景',
  },
  {
    id: 'woodcut_print',
    name: '版画木刻风',
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：纯色块无渐变、极简轮廓线、无阴影、高饱和度、装饰性构图、二维平面感、现代插画语言',
  },
  {
    id: 'chibi_moe',
    name: 'Q 版萌系风',
    ...
    promptModifier: '核心视觉特征：大头身比例（2-4头身）、圆润弧线、简化五官、柔和色彩、软萌质感、夸张表情、童趣感',
  },
  {
    id: 'cyberpunk',
    name: '赛博朋克风',
    ...
    promptModifier: '核心视觉特征：霓虹光影（洋红/青蓝）、高对比暗调、雨夜湿润反光、全息投影光效、义体机械质感、未来破败感、数字噪点',
  },
  {
    id: 'vaporwave',
    name: '蒸汽波风',
    ...
    promptModifier: '核心视觉特征：粉紫蓝调色盘、怀旧VHS质感、光影迷离、故障错位、古典雕塑元素拼贴、网格线、复古电脑界面、梦幻氛围',
  },
  {
    id: 'glitch_art',
    name: '故障艺术风',
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：粗犷外轮廓、动态夸张、纯色填充、幽默表情、动作线、漫画速度线、高对比色彩',
  },
  {
    id: 'pop_art_comic',
    name: '波普漫画风',
    ...
    promptModifier: '核心视觉特征：网点纹理、本戴点、对话气泡框、高饱和度原色、重复图案、美式复古漫画印刷感',
  },
  {
    id: 'cel_shading',
    name: '赛璐珞平涂风',
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：黄铜金属质感、齿轮机械结构、皮革与木材纹理、维多利亚时代色调、复古仪器感、蒸汽氛围、工业复古美学',
  },
  {
    ...
    promptModifier: '核心视觉特征：新海诚动画风格，通透的天空，丁达尔光效，背景细腻，柔和的人物线条，治愈氛围，高饱和度清新配色',
  },
  {
    id: 'morandi_color',
    name: '莫兰迪色系风',
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：哥特暗黑风格，高对比度暗色调，尖锐建筑轮廓，冷冽光影，华丽颓废角色造型，神秘压抑氛围',
  },
  {
    id: 'japanese_forest',
    name: '日式清新森系风',
    ...
    promptModifier: '核心视觉特征：日式清新森系风，暖调自然光，浅绿米白配色，宽松棉麻服饰，森林庭院背景，慵懒治愈氛围',
  },
  {
  ...
  },
  {
    ...
    promptModifier: '核心视觉特征：奇幻诡异场景（扭曲森林、糖果屋、古堡），低饱和度暗色调搭配局部亮色（鲜红苹果、幽蓝萤火），人物造型夸张带童话感，氛围神秘且略带惊悚',
  },
  {
