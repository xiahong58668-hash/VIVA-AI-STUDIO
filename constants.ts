...
export const SCRIPT_CATEGORIES: ScriptCategory[] = [
  {
    ...
    templates: [
      { id: 'rapid_reversal', name: '极速反转', description: '以 “意料之外、情理之中” 为核心，前半段铺垫日常剧情，后半段用强转折打破预期，节奏快、爽点密集，极易引发分享与讨论。' },
      { id: 'human_emotions', name: '人间情感', description: '聚焦亲情、友情、爱情等真实情感，用细腻故事戳中人心，主打温暖、治愈或遗憾的情绪共鸣，受众广泛且粘性高。' },
      { id: 'silly_brain_holes', name: '沙雕脑洞', description: '以无厘头、清奇脑洞为卖点，用荒诞设定 + 反差笑点制造快乐，适合短平快喜剧内容，自带传播属性，轻松吸引年轻用户。' },
      { id: 'thriller_ghost_stories', name: '惊悚怪谈', description: '营造紧张、悬疑、恐怖氛围，通过未知恐惧、灵异事件或都市传说抓住注意力，氛围感强、代入感足，适合悬疑向内容。' },
      { id: 'workplace_games', name: '职场博弈', description: '围绕职场竞争、晋升、人际冲突展开，刻画办公室政治、利益博弈与个人成长，精准吸引职场人群，引发现实共鸣。' },
      { id: 'youth_healing', name: '青春治愈', description: '以校园、成长、青春懵懂为核心，讲述青涩暗恋、友情陪伴、追梦故事，风格温暖治愈，主打学生及怀念青春的成年用户。' },
      { id: 'cultivation_power_fantasy', name: '修仙爽文', description: '经典男频题材，主角从底层起步，通过修炼、奇遇一路升级打脸，爽点密集、节奏快，受众稳定且付费意愿强。' },
      { id: 'doomsday_survival', name: '末日生存', description: '设定在末世背景下，讲述人类对抗丧尸、天灾、资源匮乏的求生故事，强调生存压力与人性考验，氛围感极强。' },
      { id: 'rebirth_counterattack', name: '重生逆袭', description: '主角带着前世记忆 / 经验重生，弥补遗憾、打脸仇人、走上人生巅峰，爽点直接、代入感强，是网文 / 短剧的顶流题材。' },
      { id: 'ancient_power_struggles', name: '古风权谋', description: '以古代宫廷、朝堂、江湖为舞台，讲述权力斗争、阴谋诡计与家国大义，格局宏大、剧情复杂，适合喜欢深度剧情的用户。' },
      { id: 'strong_female_lead', name: '女强爽恋', description: '女主独立清醒、事业爱情双丰收，既有搞事业的爽感，又有甜宠恋爱的糖分，精准戳中女性受众，是当前热门方向。' },
      { id: 'workplace_slacking', name: '职场摸鱼', description: '以职场摸鱼、反内卷日常为笑点，用轻松幽默的方式吐槽职场压力，适合短喜剧、段子内容，极易引发职场人共鸣。' },
      { id: 'hardcore_investigation', name: '硬核探案', description: '侧重逻辑推理、刑侦破案，通过抽丝剥茧的过程还原真相，强调严谨性与悬念感，适合喜欢烧脑内容的用户。' },
      { id: 'power_fantasy_counterattack', name: '爽文逆袭', description: '泛指主角从底层崛起、打脸反派、实现阶层跨越的故事（可适配都市 / 校园 / 玄幻等背景），爽点直接、受众覆盖广。' },
      { id: 'rules_ghost_stories', name: '规则怪谈', description: '以 “必须遵守的诡异规则” 为核心，通过违反规则的恐怖后果制造恐惧，是近年热门悬疑流派，自带猎奇感与传播力。' },
      { id: 'hot_blooded_youth', name: '青春热血', description: '围绕运动、追梦、反抗、成长展开，用激情、热血的剧情点燃情绪，适合校园竞技、成长向内容，吸引年轻用户与学生群体。' },
    ]
  }
];
